// ==UserScript==
// @name         CHUN KING SharePoint Smart Forms Auto-Bridge
// @namespace    https://k35n.sharepoint.com/
// @version      1.3
// @description  自動在 SharePoint 父視窗建立 API 通信與路由橋樑，使內嵌智能表單支援自動頁籤跳轉與直接送出
// @author       CHUN KING
...
(function () {
    ...
    console.log("🚀 [CHUN KING] SharePoint 智慧表單自動通信與路由橋樑已就緒！");
